                    ...
                    <div class="col-lg-4">
                        <div class="login-content card">
                            <div class="login-form">
                                ...
                                <form id="form-login" method="post" action="<?= site_url('fedd/verificarLogin') ?>">
                    				...
                    				<div class="form-group">
                                    	<label>Ano</label>
                            			<input id="anofiscal" name="anofiscal" class="form-control" type="text" placeholder="Ano Fiscal" />
                        			</div>
        ...
        $(document).ready(function () {
            ...
            $("#form-login").validate({
                ...
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= site_url('fedd/verificarLogin?ajax=true'); ?>",
                        data: dados,
                        dataType: 'json',
                        success: function (data) {
                            if (data.result == true) {
                                window.location.href = "<?= site_url('fedd'); ?>";
                            }
                            else {
