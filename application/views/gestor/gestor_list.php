		...
		<div class="card">
			<div class="card-body">
				<div class="card-content table-responsive">
					<?= anchor(site_url('gestores/create'),'<i class="fa fa-plus"></i> '.$this->lang->line('app_create'), 'class="btn btn-success"'); ?>
						...
						<table id="table" class="table table-bordered" style="margin-bottom: 10px; width:100%">
							...
							<thead>
								<tr>
                                    ...
                                    <th>
										<?= ucfirst($this->lang->line('ordenador')) ?>
									</th>
                                    <th>
										<?= ucfirst($this->lang->line('agente')) ?>
									</th>
                                    <th>
...
<script type="text/javascript">  
	$(document).ready(function () {
		...
		var datatable = $('#table').DataTable({
			...
			"order": [],
			"ajax": {
				url: "<?= site_url('gestores/datatable'); ?>",
				type: "POST"
			},
			"columnDefs": [
				{
