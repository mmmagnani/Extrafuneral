<div class="col-lg-12 col-md-12 col-sm-12">
	<div class="card">
		<div class="card-title">
			<h4>
				<i class="fa fa-eye"></i>
				<?= $this->lang->line('app_view').' '.ucfirst($this->lang->line('fe')); ?>
			</h4>
		</div>
		<div class="card-body">
			...
			<div class="vtabs">
				<ul class="nav nav-tabs tabs-vertical" role="tablist">
					<li class="nav-item"> <a class="nav-link active show" data-toggle="tab" href="#info" role="tab" aria-selected="true"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Dados FE</span> </a> </li>
					...
					<div class="tab-pane active show" id="info" role="tabpanel">
						<table class="table table-bordered table-striped">
							...
							<tr>
								...
								<td>
									<?= ucfirst($this->lang->line('num_msg_siafi_aut')) ?>
								</td>
								<td class="text-left">
									<?= $num_msg_siafi_aut; ?>
								</td>
								...
								<td>
									<?= ucfirst($this->lang->line('num_msg_siafi_sol')) ?>
								</td>
								<td class="text-left">
									<?= $num_msg_siafi_sol; ?>
								</td>
			...
			<hr>
			<a href="<?= site_url('fes/create') ?>" class="btn btn-success">
				<i class="fa fa-plus"></i>
				<?= $this->lang->line('app_create'); ?>
			</a>
			<a href="<?= site_url('fes/update/'.$registro_id) ?>" class="btn btn-info">
			...
			<a style="margin-left:20px" href="<?= site_url('fes/printCautela/'.$registro_id) ?>" target="_blank" class="btn btn-primary">
