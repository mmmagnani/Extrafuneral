		...
		<div class="card">
			<div class="card-body">
				...
				<div class="card-content table-responsive">
					<?= anchor(site_url('fes/create'),'<i class="fa fa-plus"></i> '.$this->lang->line('app_create'), 'class="btn btn-success"'); ?>
						...
						<form id="form_delete" method="post">
							...
							<table id="table" class="table table-bordered" style="margin-bottom: 10px; width:100%">
								...
								<thead>
									<tr>
										<th>
										<?php if ($this->permission->check($this->session->userdata('permissao'), 'dFe')) { ?>
